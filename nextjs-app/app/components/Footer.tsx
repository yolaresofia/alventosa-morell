...
export default function Footer({ block }: FooterProps) {
  ...
  return (
    <footer className="text-[#ECE8E2] flex flex-col space-y-4 lg:grid grid-cols-5 gap-4 items-start text-base justify-between pb-40 pt-20 lg:px-20 px-8 bg-[#712538] z-50 w-full border-t border-[#ECE8E2]">
      <Link href="/">
        <img
